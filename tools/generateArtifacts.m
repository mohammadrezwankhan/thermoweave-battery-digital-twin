...
study3d = generate3DResearchArtifacts();
evidence = struct( ...
...
portableEvidence.study3d.reportPath = "artifacts/reports/3d-study-summary.json";
portableEvidence.study3d.moduleFigurePath = "artifacts/figures/3d-module-temperature.png";
portableEvidence.study3d.layerFigurePath = "artifacts/figures/3d-layer-response.png";
portableEvidence.study3d.csvPath = "artifacts/data/3d-study-results.csv";
